...
<header class="text-gray-700 body-font">
  <div class="container bg-primary mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <?php
      ...
      {
        echo "<a href='login.php'><button class='inline-flex items-center bg-green-200 border-0 py-1 px-3 focus:outline hover:bg-green-300 rounded text-base mt-4 md:mt-0'>Login
                <svg fill='none' stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' class='w-4 h-4 ml-1' viewBox='0 0 24 24'>
                <path d='M5 12h14M12 5l7 7-7 7'></path>
                </svg>
                </button></a>";
